# -*- coding: utf-8 -*-
"""
Created on Wed May 22 13:51:41 2024
...
project = 'Kayapo'
results = satellite_analysis(project)
"""
...
relLossinfo = results[4].getInfo()*100
print("Calculation of Real Loss complete")


relGaininfo = results[5].getInfo()*100
...
data= {'Net_Change':net, 'Area_Loss':results[0].getInfo(),'Area_Gain':results[1].getInfo(), 'Statistical_Loss':results[2].getInfo(),'Statistical_Gain':results[3].getInfo(),'Realative_Loss':results[4].getInfo(),'Realtive_Gain':results[5].getInfo()}
