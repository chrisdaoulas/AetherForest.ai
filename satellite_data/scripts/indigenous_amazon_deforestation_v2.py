...
ee.batch.Export.image.toAsset(**{
  ...
  "description": 'classified2015_10m1',
  "assetId":'projects/ee-blockchain/assets/classified2015_10m1',
  "scale":10,
  "crs": 'EPSG:32721',
  "region": kayapo,
  "maxPixels": 1e13
...
ee.batch.Export.image.toAsset(**{
  ...
  "description": 'classified2023_10m2',
  "assetId":'projects/ee-blockchain/assets/classified2023_10m2',
  "scale":10,
  "crs": 'EPSG:32721',
  "region": kayapo,
  "maxPixels": 1e13
...
classified2015_10m = ee.Image('projects/ee-blockchain/assets/classified2015_10m1')
classified2023_10m = ee.Image('projects/ee-blockchain/assets/classified2023_10m1')


# Export images to local folder
filename1 = os.path.join(os.getcwd()+'\\toipfs\\', 'landsat.tif')
filename2 = os.path.join(os.getcwd()+'\\toipfs\\', 'sentinel.tif')
...
#print('Forest Classification 2023 10m scale: ', classified2023_10m.projection().nominalScale())


#load images back as new layers
#Map.addLayer(classified2015_10m, {min:0,max:1,'palette': palette},'Forest Classification 2015 10m')
#Map.addLayer(classified2023_10m, {min:0,max:1,'palette': palette},'Forest Classification 2023 10m')
...
with open(os.getcwd()+'\\toipfs\\data.txt', 'w') as file:
...
#geemap.ee_export_image(classified2023_10m.visualize(**{'bands': ['B4','B3','B2'],'min': 0.0, 'max': 0.3,'palette':['00FFFF', '0000FF']}), filename=filename, scale=90, region=kayapo, file_per_band=False)
geemap.ee_export_image(classified2023_10m.visualize(**{'min':0,'max':1,'palette': palette}), filename=filename1, scale=90, region=kayapo, file_per_band=False)
geemap.ee_export_image(classified2015_10m.visualize(**), filename=filename2, scale=90, region=kayapo, file_per_band=False)
