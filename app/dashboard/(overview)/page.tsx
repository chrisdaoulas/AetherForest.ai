    ...
    return (
      <div className=" text-justify "  >
         ...
         <Head>
          ...
          <h2 className={`${lusitana.className} text-2xl  items-full`} style={{  margin:  "10px"}}>An Open Permissioned ReFi Carbon Market Blockchain Prototype</h2>
        
         
          {/* style={{  margin:  "10px",textAlign: "justify", padding: "20px"}} mt-4 items-full mx-0*/}
        ...
        <footer className={`${lusitana.className} text-1xl `} style={{  margin:  "10px"}}>
          ...
          <p className='mb-2'>AmazonasCoin invites you to be part of this transformative journey towards sustainable governance. By leveraging blockchain technology, we envision a future where accountability, collaboration, and environmental stewardship go hand in hand.</p>
