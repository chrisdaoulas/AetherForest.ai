  ...
  return (
    <div>
      ...
      <h2 className='mt-10 mb-2'><strong>Whitepaper</strong></h2>
        <p>Read our whitepaper for more in-depth information about AetherForest.ai and AmazonasCoin <a className="md:text-green-600" 
